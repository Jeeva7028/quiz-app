        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card bg-light mb-3">
                    <div class="card-header"  style="background-color: #ae9595; color: #fff;">What is Quiz?</div>
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card bg-light mb-3">
                    <div class="card-header" style="background-color: #ae9595; color: #fff;">How to Play</div>
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card bg-light mb-3">
                    <div class="card-header" style="background-color: #ae9595; color: #fff;">Rules</div>
                    <div class="card-body">
